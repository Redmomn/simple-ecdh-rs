use crate::{EllipticCurve, EllipticPoint};
...
pub static SECP192K1: Lazy<EllipticCurve> = Lazy::new(|| EllipticCurve {
    p: BigInt::from_bytes_le(
        Sign::Plus,
        &[
            0x37, 0xEE, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    ...
    g: EllipticPoint::new(
        BigInt::from_bytes_le(
            Sign::Plus,
            &[
                0x7D, 0x6C, 0xE0, 0xEA, 0xB1, 0xD1, 0xA5, 0x1D, 0x34, 0xF4, 0xB7, 0x80, 0x02, 0x7D,
                0xB0, 0x26, 0xAE, 0xE9, 0x57, 0xC0, 0x0E, 0xF1, 0x4F, 0xDB,
            ],
        ),
        BigInt::from_bytes_le(
            Sign::Plus,
            &[
                0x9D, 0x2F, 0x5E, 0xD9, 0x88, 0xAA, 0x82, 0x40, 0x34, 0x86, 0xBE, 0x15, 0xD0, 0x63,
                0x41, 0x84, 0xA7, 0x28, 0x56, 0x9C, 0x6D, 0x2F, 0x2F, 0x9B,
            ],
        ),
    ),
    n: BigInt::from_bytes_le(
